...
Keep the writer's level of certainty. Hedges such as "probably", "may", "might", "about", "usually" and "some" stay, because they are part of the meaning. Never turn a guess into a claim or a claim into a guess.
...
const STRENGTH_NOTES = {
  ...
  balanced: 'Apply the full house style. Rework sentences where the rhythm is flat, but keep the writer\'s voice recognisable. '
    + 'Every paragraph of three or more sentences gets at least one sentence under 10 words, and no three sentences in a row have a similar length.',
  bold: 'Rewrite substantially: most sentences should read differently from the source, not just have a word swapped. '
    + 'In every paragraph of two or more sentences, include at least one sentence under 8 words and, where the content allows, one of 20 words or more. '
    + 'Never three sentences of similar length in a row. Reorder clauses, merge short choppy sentences, split long ones, and open some sentences with a blunt word or a question. '
    + 'Swap generic phrasing for concrete wording drawn from the text. '
    + 'Meaning, facts, hedges, headings, list numbering and paragraph breaks stay exactly as given.',
};
