...
export function buildUserMessage({
  ...
  if (rubricText.trim()) {
    ...
    if (c.formalRegister) overrides.push('Hold a formal academic register throughout. No idiom, no jokes, no conversational asides. Rhythm and sentence variety still matter; informality does not.');
